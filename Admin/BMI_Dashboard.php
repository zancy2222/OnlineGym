...
if (isset($_POST['delete_id'])) {
    ...
    // Query to delete BMI record based on ID
    $delete_sql = "DELETE FROM bmi_records WHERE id = $delete_id";
    if ($conn->query($delete_sql) === TRUE) {
        echo "<script>alert('Record deleted successfully');</script>";
        echo "<script>window.location.href = 'BMI_Dashboard.php';</script>"; // Redirect back to login page
        exit();
    } else {
...
// Query to fetch BMI records
$sql = "SELECT u.first_name, u.last_name, b.id, b.age, b.gender, b.height_cm, b.weight_kg, b.bmi, b.bmi_category, b.bmi_message, b.calculation_date
        FROM bmi_records b
    ...
    <div class="container">
        ...
        <aside>
            ...
            <div class="sidebar">
                ...
                <a href="BMI_Dashboard.php" class="active">
                    <span class="material-icons-sharp">
                        inventory
                    </span>
                    <h3>BMI</h3>
                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td>" . $row["bmi_message"] . "</td>";
                                echo "<td>" . $row["calculation_date"] . "</td>";
                            ...
                            echo "<tr><td colspan='10'>No BMI records found</td></tr>";
                        }
