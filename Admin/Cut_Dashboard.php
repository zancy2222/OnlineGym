...
if (isset($_POST['delete_id'])) {
    ...
    // Query to delete workout record based on ID
    $delete_sql = "DELETE FROM workouts WHERE id = $delete_id";
    if ($conn->query($delete_sql) === TRUE) {
                echo "<script>alert('Record deleted successfully');</script>";
        echo "<script>window.location.href = 'Cut_Dashboard.php';</script>"; // Redirect back to login page
        exit();
    } else {
...
// Query to fetch workout records
$sql = "SELECT u.id as user_id, u.first_name, u.last_name, w.id, w.workout_name, w.sets, w.reps, w.schedule_date, w.schedule_time 
        FROM workouts w
    ...
    <div class="container">
        ...
        <aside>
            ...
            <div class="sidebar">
                ...
                <a href="Cut_Dashboard.php" class="active">
                    <span class="material-icons-sharp">
                        fitness_center
                    </span>
                    <h3>Cut Details</h3>
